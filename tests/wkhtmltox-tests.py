...
class TestwkhtmltopdfInitialization(unittest.TestCase):
    """Test init"""

    def test_html_source(self):
        r = wkhtmltox.wkhtmltopdf('<h1>Oh hai</h1>', 'string')
    ...
    def test_options_parsing(self):
        r = wkhtmltox.wkhtmltopdf('html', 'string', options={'page-size': 'Letter'})
    ...
    def test_custom_configuration(self):
        conf = wkhtmltox.configuration()
        self.assertEqual('wkhtmltox-', conf.meta_tag_prefix)
        conf = wkhtmltox.configuration(meta_tag_prefix='prefix-')
        self.assertEqual('prefix-', conf.meta_tag_prefix)
        with self.assertRaises(IOError):
            conf = wkhtmltox.configuration(wkhtmltopdf='wrongpath')


class TestwkhtmltopdfCommandGeneration(unittest.TestCase):
    """Test command() method"""

    def test_command_construction(self):
        r = wkhtmltox.wkhtmltopdf('html', 'string', options={'page-size': 'Letter', 'toc-l1-font-size': 12})
        command = r.command()
    ...
    def test_read_source_from_stdin(self):
        r = wkhtmltox.wkhtmltopdf('html', 'string')
    ...
    def test_file_path_in_command(self):
        ...
        r = wkhtmltox.wkhtmltopdf(path, 'file')
    ...
    def test_wkhtmltox_meta_tags_in_bad_markup(self):
        body = """
        <html>
          <head>
            <meta name="wkhtmltox-page-size" content="Legal"/>
    ...
    def test_skip_nonwkhtmltox_tags(self):
        body = """
        <html>
          <head>
    ...
    def test_toc_handling_without_options(self):
        r = wkhtmltox.wkhtmltopdf('hmtl', 'string', toc={'xsl-style-sheet': 'test.xsl'})
    ...
    def test_toc_with_options(self):
        ...
        r = wkhtmltox.wkhtmltopdf('html', 'string', options=options, toc={'xsl-style-sheet': 'test.xsl'})
    ...
    def test_cover_with_options(self):
        ...
        r = wkhtmltox.wkhtmltopdf('html', 'string', options=options, cover='test.html')
    ...
    def test_cover_and_toc(self):
        ...
        r = wkhtmltox.wkhtmltopdf('html', 'string', options=options, toc={'xsl-style-sheet': 'test.xsl'}, cover='test.html')
        command = r.command()
    ...
    def test_cover_and_toc_cover_first(self):
        ...
        r = wkhtmltox.wkhtmltopdf('html', 'string', options=options, toc={'xsl-style-sheet': 'test.xsl'}, cover='test.html', cover_first=True)
        command = r.command()
...
class TestwkhtmltopdfGeneration(unittest.TestCase):
    """Test to_pdf() method"""
    ...
    def test_stylesheet_adding_to_the_head(self):
        ...
        r = wkhtmltox.wkhtmltopdf('<html><head></head><body>Hai!</body></html>', 'string',
    ...
    def test_stylesheet_adding_without_head_tag(self):
        r = wkhtmltox.wkhtmltopdf('<html><body>Hai!</body></html>', 'string',
    ...
    def test_stylesheet_throw_error_when_url(self):
        r = wkhtmltox.wkhtmltopdf('http://ya.ru', 'url', css='fixtures/example.css')
